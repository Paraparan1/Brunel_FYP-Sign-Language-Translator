...
dataDir = "Sign Language Dataset 2"
...
#Stores all predictions in a list.
y_predicted = np.argmax(y_pred,axis=-1)

#Uses predictions and true labels to form a confusion matrix.
cm = confusion_matrix(y_target=Y_val,
